...
export const WIDGETS: readonly WidgetDef[] = [
  ...
  // effects
  {
    name: "Blur",
    module: "effects",
    doc: "Blurs what is behind the object (`blurOn: background`) or the object itself, uniformly or progressively.",
    keys: [
      k("blurOn", "enum", "What to blur.", { values: ["background", "object"], default: "background" }),
      k("type", "enum", "Uniform or progressive (a gradient of blur).", { values: ["uniform", "progressive"], default: "uniform" }),
      k("value", "len", "Blur radius (uniform).", { default: "12", animatable: true }),
      k("values", "any", "Progressive: blur radii at the stops, e.g. `(0, 25)`."),
      k("stops", "any", "Progressive: stop positions 0–1, e.g. `(0, 1)`."),
      k("direction", "any", "Progressive: from/to alignment, e.g. `(t, b)`."),
      ...box(),
    ],
    groups: [BORDER_GROUP],
    slots: [ONE],
    tag: "div",
    layout: "box",
    example: "Blur(.config(blurOn: background, value: 20) .obj(Container(.config(size: 200, color: black.alpha(25%)))))",
  },
  {
    name: "Mask",
    module: "effects",
